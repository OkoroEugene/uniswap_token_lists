...
This NPM module and GitHub repo contains the default token list used in the Uniswap interface built on [@uniswap/default-token-list](https://github.com/Uniswap/default-token-list).
